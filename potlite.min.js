 ...
 */
(function(c,g){var m={VERSION:"1.01",TYPE:"lite"},q=Array.prototype.slice,f=Array.prototype.concat,u=Object.prototype.toString,l=/List|Collection/i,e=/^[\s\u00A0\u3000]+|[\s\u00A0\u3000]+$/g,n=/([-.*+?^${}()|[\]\/\\])/g,o,t,i,h;
...
}catch(D){throw E}}}}return E}m.update({arrayize:y,stringify:s,trim:v,rescape:w,invoke:z,debug:p});
...
E<B;++E){C=31*C+F.charCodeAt(E);C%=A}return C}});m.update({XPCOM:{}});j(m.XPCOM,{isEnabled:(function(){var B=false,A;
