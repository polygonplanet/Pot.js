 ...
 */
(function(globals,undefined){var Pot={VERSION:"1.15",TYPE:"lite"},slice=Array.prototype.slice,concat=Array.prototype.concat,toString=Object.prototype.toString,hasOwnProperty=Object.prototype.hasOwnProperty,RE_ARRAYLIKE=/List|Collection/i,RE_TRIM=/^[\s\u00A0\u3000]+|[\s\u00A0\u3000]+$/g,RE_RESCAPE=/([-.*+?^${}()|[\]\/\\])/g,RE_PERCENT_ENCODED=/^(?:[a-zA-Z0-9_~.-]|%[0-9a-fA-F]{2})*$/,Ci,Cc,Cr,Cu;
...
}}}}}catch(e){result=false}return result},isArrayLike:function(o){var len;if(!o){return false
}if(Pot.isArray(o)||o instanceof Array||o.constructor===Array){return true}len=o.length;
if(!Pot.isNumber(len)||(!Pot.isObject(o)&&!Pot.isArray(o))||o===Pot||o===Pot.Global||o===globals||Pot.isWindow(o)||Pot.isDocument(o)||Pot.isElement(o)){return false
...
}return o}function arrayize(object,index){var array,i,len,me=arguments.callee,t;if(me.canNodeList==null){if(globals||Pot.Global){try{t=slice.call(((globals&&globals.documentElement)||(Pot.Global&&Pot.Global.documentElement)).childNodes)[0].nodeType;
...
iterable=Pot.Iter.toIter(object);if(!Pot.isIter(iterable)){return this.noop()}if(Pot.isFunction(callback)){return{next:function(){var results=iterable.next();
results.push(object);that.result=callback.apply(context,results);return that.result
}}}else{return{next:function(){that.result=iterable.next();return that.result}}}}});
Pot.Internal.LightIterator.prototype.doit.prototype=Pot.Internal.LightIterator.prototype;
...
}},{NAME:"repeat",method:Pot.Deferred.repeat,context:null,speed:true,iterable:Pot.Deferred.repeat,args:function(arg,args){if(arg&&Pot.isNumber(arg.length)){return[arg.length].concat(args)
}if(arg&&Pot.isObject(arg)&&("end" in arg||"begin" in arg||"step" in arg||"stop" in arg||"start" in arg)){return[arg].concat(args)
